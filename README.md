...
- Оформи решение как статическую библиотеку с названием *_string.a* (с заголовочным файлом _string.h);
...
- Предусмотри Makefile для сборки библиотеки и тестов (с целями all, clean, test, _string.a, gcov_report);
...
- Функция должна быть размещена в библиотеке _string.h;
...
- Функции должны быть размещены в библиотеке _string.h;
